 ...
 * </p>
 * <p>
 * Description: 数据库工具类，实现java.util.List接口，储存各个对象的UUID， 当需要的时候才从数据中取得实际的数据对象
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public abstract class DbUSMList extends AbstractList implements Cloneable,
		Serializable {
	...
	public Object clone() {
		try {
			DbUSMList v = (DbUSMList) super.clone();
	...
	public Object get(int index) {
		RangeCheck(index);
		prepareGet(index);
		return getUSMObject(elementData[index]);
	}
	 ...
	 * @return
	 */
	protected abstract Object getUSMObject(Object obj);
