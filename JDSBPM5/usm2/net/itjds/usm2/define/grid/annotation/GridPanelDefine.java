...
public @interface GridPanelDefine {
	...
	String ftlUrl() default "grid.ftl";
	

	@MethodChinaName(cname = "重启话机")
	AjaxDataDefine restartTelephone() default @AjaxDataDefine(url="") ;
	
	@MethodChinaName(cname = "导入人员")
	AjaxDataDefine importPerson() default @AjaxDataDefine(url="") ;
	
	@MethodChinaName(cname = "导出人员")
	AjaxDataDefine exportPerson() default @AjaxDataDefine(url="") ;
	
	AjaxDataDefine loadData() default @AjaxDataDefine(
			url="expression.jsp?expression=$JSONGrid"
	); 
