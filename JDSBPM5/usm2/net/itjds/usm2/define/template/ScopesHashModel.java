/*
 * $Id: ScopesHashModel.java,v 1.1 2011/08/03 09:38:57 liyang Exp $
 *
...
public class ScopesHashModel extends SimpleHash {
    ...
    public ScopesHashModel(ObjectWrapper objectWrapper,  HttpServletRequest request, ValueStack stack) {
        super(objectWrapper);
       
        this.request = request;
  
        this.stack = stack;
        this.put("requestparams", request.getParameterMap());
    }
    ...
    public TemplateModel get(String key) throws TemplateModelException {
        ...
        if (stack != null) {
            ...
            obj = ActionContext.getContext().getSession().get(key);
            if (obj != null) {
                return wrap(obj);
            }
        }
