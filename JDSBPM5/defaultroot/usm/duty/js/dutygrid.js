...
var store = new Ext.data.Store({
    ...
    var grid4 = new xg.GridPanel({
       ...
       cm: new xg.ColumnModel([
            sm,
            {id:'CnName',header: "职务名称", width: 40, sortable: true, dataIndex: 'CnName'},
            {header: "职务说明", width: 20, sortable: true,  dataIndex: 'DutyDesc'},
           // {header: "排序号", width: 20, sortable: true, dataIndex: 'PositionTabIndex'},   
            {header: "管理员标志", width: 20, sortable: true, dataIndex: 'AdminFlag'},        
            {header: "创建时间", width: 20, sortable: true, renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'CreateTime'},
            //{header: "职务级别", width: 20, sortable: true, dataIndex: 'DutyEvel'},
        ...
        tbar:[{
            ...
            iconCls:'option',
            handler:function(){
            window.location="dutymodify.jsp"; 
            }
...
Ext.grid.dummyData = [
    ['研发部Java工程师','ddd','1','7/21 12:00am','详情']
];
