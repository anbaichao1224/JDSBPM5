...
Ext.onReady(function(){
	//alert("is here person list");
    var newFormWin;

    Ext.QuickTips.init();
    function personNameClike(personid,cnname){
       return " <a href=javascript:window.location='/usm/getPersonDetail.do?personid="+personid+"'  style='text-decoration: none;color: #blue' >" + cnname +"</a>";
    }
    var xg = Ext.grid;
    var p = "";
    ...
    var loadFormData = function(persongrid) {
        ...
        if (!_record) {
           ...
           if(_record.get('househao')=='null')
           {
             Ext.getCmp("househao").value= '';
           }else
           {
           	 Ext.getCmp("househao").value=_record.get('househao');
           }
    ...
    var myFormWin = function() {
        ...
        if (!newFormWin) {
            newFormWin = new Ext.Window( {
            	...
            	window.location="orgPersonListgrid.jsp?orgid="+orgid; 	
            	return false;	
            	}}
            });
        }
...
//        }
 ...
 buttons: [{
            text: '返回',
            handler: function() {
               window.location="orgPersonListgrid.jsp";  
            }
        }
