        ...
        items: [{
            ...
            items:[                  
		        ...
		        items: [       
                       {      
                	   title:'',
               		   html:'<img id="img" border="0" width="100" height="120" src="/usm/upload/no.jpg"/>'    
	                   }
	                   ] 
	            },{  
                columnWidth:.4,            
 ...
 buttons: [{
            ...
            handler: function(){
                if(fsf.form.isValid()) {
                    ...
                    flag = false;
                    fsf.getForm().submit({ 
                        url: '/usm/personInfoModify.do?personid='+personid,
                        method: 'POST',
                        waitTitle: '请稍等……', 
                        waitMsg: '正在上传数据……',  
                        success: function() {
                            Ext.Msg.alert("成功", "操作成功！");
                            window.location="getPersonDetailInfo.do?personid="+personid; 
                            this.disabled=false;
                        },
                        failure: function() {
