...
<script type="text/javascript">
 ...
 var politicalstat='<s:property value="personinfo.politicalstat"/>';
  ...
  else 
  {
    ...
    <link rel="stylesheet" type="text/css" href="<%=contextpath%>usm/js/ext/resources/css/ext-all.css" />
    <script src="<%=contextpath%>usm/js/ext/adapter/ext/ext-base.js"></script>
    <script src='<%=contextpath%>usm/js/ext/ext-all.js'></script>
    <script type="text/javascript" src="/usm/usm/js/FileUploadField.js"></script>
    <link rel="stylesheet" type="text/css" href="/usm/usm/resources/css/file-upload.css"/> 
    <script type="text/javascript" src="/usm/usm/js/FileUploadField.js" ></script>
    <script type="text/javascript" src="/usm/usm/person/js/ShowInfo.js" defer="defer"> </script>
