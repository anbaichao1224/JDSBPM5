 ...
 TreeData.emptyTreeData=[{"text":"机构","id":"root","children":[{"text":"门头沟","id":"236009090","children":[],"uid":"236009090","fieldName":"236009090","cnName":"门头沟","expression":"","leaf":false},{"text":"门头沟222","id":"236009091","children":[],"uid":"236009090","fieldName":"236009090","cnName":"门头沟","expression":"","leaf":false}],"uid":"root","fieldName":"root","cnName":"机构","expression":"","leaf":false}];
  ...
  TreeData.attNames={
                    ...
                    text:{text:"机构名称",display:true},
                    fieldName:{text:"机构代码",display:true},
                    cnName:{text:"外部代码",display:true},
                    expression:{text:"级别",display:true}
                   };

//不可拖动,删除,修改的节点id,这些节点下的子节点不可跨此节点拖动
//TreeData.staticNodeId=["rowhead","colhead","group","head","foot","body","root"];
TreeData.staticNodeId=[];
...
//      }
  ...
  if(TreeData.attwin)
  {
      TreeData.attwin.close();
      TreeData.attwin = null;
  }
  var win = new Ext.Window(winParam);
  TreeData.attwin = win;
  win.on("close",resetWoorkBook);
  win.show();
  win.maximize();  
}
...
function resetWoorkBook()
{
    var div=document.getElementById('worksheet').cloneNode(false);
    var pDiv=document.getElementById('worksheet').parentNode;
