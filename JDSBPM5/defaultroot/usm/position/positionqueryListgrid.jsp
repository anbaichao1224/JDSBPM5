...
<script type="text/javascript">
    ...
    <!-- <script type="text/javascript" src="<%=contextpath%>/usm/position/js/RowExpander.js"></script> -->
    <script type="text/javascript" src="<%=contextpath %>usm/position/js/positionquerygrid.js" defer="defer"></script>
