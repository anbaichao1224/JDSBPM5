   ...
   var store = new Ext.data.Store({
    ...
    var grid4 = new xg.GridPanel({
       ...
       cm: new xg.ColumnModel([
            sm,
            {id:'CnName',header: "角色名称", width: 40, sortable: true, dataIndex: 'CnName'},
            {header: "角色说明", width: 20, sortable: true,  dataIndex: 'RoleDesc'},
            {header: "是否管理用", width: 20, sortable: true, dataIndex: 'AdminFlag'},        
        ...
        tbar:[{
            ...
            iconCls:'option',
            handler:function(){
            window.location="rolemodify.jsp"; 
            }
