...
<head>
    ...
    <script type="text/javascript" src="<%=contextpath%>usm/role/js/SearchField.js"></script>
    <script type="text/javascript" src="<%=contextpath%>usm/role/js/roleQuery.js"></script>
