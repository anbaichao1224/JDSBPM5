...
<script type="text/javascript">
	       ...
	       var cnname='<s:property value="position.cnname"/>';
	       var roledesc='<s:property value="position.roledesc"/>';
</script>
    <link rel="stylesheet" type="text/css" href="<%=contextpath%>js/ext/resources/css/ext-all.css" />
    <script src="<%=contextpath%>js/ext/adapter/ext/ext-base.js"></script>
    <script src='<%=contextpath%>js/ext/ext-all.js'></script>
    <script type="text/javascript" src="<%=contextpath%>usm/role/js/RowExpander.js"></script>
    <script type="text/javascript" src="<%=contextpath%>usm/role/js/positionrolequerygrid.js"  defer="defer"></script>
