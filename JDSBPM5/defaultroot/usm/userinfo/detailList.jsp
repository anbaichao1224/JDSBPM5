...
<script type="text/javascript" src="<%=path%>js/extAll.js"></script>
	    <script  src="<%=path%>bpm/userclient/js/JDS.js" type="text/javascript"></script>
	        <script  src="<%=path%>bpm/userclient/js/deskTopAll.js" type="text/javascript"></script>
		<script  src="<%=path%>bpm/userclient/worklist/js/WorkList.js" type="text/javascript"></script>
		<script  src="<%=path%>desktop/widgets/bpm/form/display/js/Form.js" type="text/javascript"></script>
		  <script  src="<%=path %>cwzx/cwzxclient/common.js" type="text/javascript"></script>
</head>
<body>
...
<table width="750"  align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" class="xs_left_top"><ww:if test="number != null "><ww:property value="number"/></ww:if>&nbsp;</td>
    <td valign="top" class="xs_left_top"><ww:if test="name != null "><ww:property value="name"/></ww:if>&nbsp;</td>
    <td valign="top" class="xs_left_top"><ww:if test="title != null ">
    <ww:if test="isHis=='false'">
    <a  href="#" onclick="openWin('demodisplay.action?activityInstId=<ww:property  value="lastActivityInstId"/>')"><ww:property value="title"/></a>
    </ww:if><ww:else>
    <a  href="#" onclick="openWin('demohisdisplay.action?activityInstHistoryId=<ww:property value="lastActivityInstId"/>')"><ww:property value="title"/></a></ww:else>
    </ww:if></td>
    <td valign="top" class="xs_left_top"><ww:if test="sort != null "><ww:property value="sort"/></ww:if>&nbsp;</td>
    <td valign="top" class="xs_left_top"><ww:if test="dept != null "><ww:property value="dept"/></ww:if>&nbsp;</td>
    <td valign="top" class="xs_left_top"><ww:if test="condition != null "><ww:property value="condition"/></ww:if>&nbsp;</td>
    <td valign="top" class="xs_left_top_right"><ww:if test="opinion != null "><ww:property value="opinion"/></ww:if>&nbsp;</td>    
  </tr>
  </ww:iterator>
  <tr>
...
<center>
<ww:if test="processList.size > 0">
<a onclick="javascript:saveExcel()"><span style="color:blue;" onmouseover="this.style.cursor='hand'">导出到Excel</span></a>
</ww:if>
</center>
</form>
</body>
