 ...
 var store = new Ext.data.Store({
    ...
    var grid4 = new xg.GridPanel({
       ...
       cm: new xg.ColumnModel([
            sm,
            {id:'grpname',header: "用户组名称", width: 40, sortable: true, dataIndex: 'grpname'},  
            {header: "创建时间", width: 20, sortable: true, renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'CreateTime'},
            {header: "用户组标志", width: 20, sortable: true, dataIndex: 'grpflag'}
        ]),
        sm: sm2,
        ...
        tbar:[{
            ...
            iconCls:'add',
            handler:function(){
            window.location="usergroupadd.jsp"; 
            }
        }, '-', {
            text:'修改',
            tooltip:'修改',
            iconCls:'option',
            handler:function(){
            window.location="usergroupmodify.jsp"; 
            }
