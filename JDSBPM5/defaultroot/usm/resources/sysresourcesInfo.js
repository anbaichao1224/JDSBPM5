...
Ext.onReady(function(){
    ...
    var simple = new Ext.FormPanel({
        ...
        buttons: [{
            text: '删除',
            handler:function(){ 
            	Ext.MessageBox.confirm('消息', '确认删除吗？',sysmoduleRemove);
			} 
			}]
    });

	 simple.render(document.body);
	 function sysmoduleRemove(btn){
	 	 if(btn=='yes'){
			simple.getForm().submit({url:'/usm/sysmoduleRemove.do',method:'POST',waitMsg:'正在保存数据...',success:function(form,action){ 
