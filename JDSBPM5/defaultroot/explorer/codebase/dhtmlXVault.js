...
dhtmlXVaultObject.prototype.setImgPath = function(imgPath){

	this.imgPath=imgPath;
	
}
dhtmlXVaultObject.prototype.setUploadPath = function(uploadPath){
...
dhtmlXVaultObject.prototype.create = function(htmlObject)
{
    ...
    var str = "<table style='background-color:#EDEEEF;border: 1px solid #7A7C80;' border='0'>" +
              ...
              "<img _onclick='UploadControl.prototype.uploadAllItems()' _ID='ImageButton3'  src='"+this.imgPath+"/btn_upload.gif' style='cursor:pointer'/></td>" +
              "<td style='width: 140px; height: 32px;' align='right'>" +
              "<img _onclick='return UploadControl.prototype.removeAllItems()' _ID='ImageButton3'  src='"+this.imgPath+"/btn_clean.gif' style='cursor:pointer;margin-right:20px'/></td></tr></table>" +

              "<div _id='fileContainer' style='width:84px;overflow:hidden;height:32px;left:0px;direction:rtl;position:absolute;top:211px'>" +
              "<img style='z-index:2' src='"+this.imgPath+"/btn_add.gif'/>" +
    ...
    this.UPLOAD_PATH = document.createElement("input");
    this.UPLOAD_PATH.type = "hidden";
    this.UPLOAD_PATH.name = "uploadPath";
    this.UPLOAD_PATH.value = this.uploadPath;
    
    this.uploadForm.appendChild(this.UPLOAD_PATH);
...
dhtmlXVaultObject.prototype.addFile = function()
{
    ...
    cellList.innerHTML = "<a href='#remove' class='link'>删除</a>";
    ...
    cellList = document.createElement("td");
    cellList.style.cssText = ";width:140px;height:30px;";
    cellList.innerHTML = "<a href='#upload' class='link'>上传</a>";
    cellList.firstChild.onclick = function() {
...
{
    var srcImgProgress = ""+this.imgPath+"/pb_demoUload.gif";
...
dhtmlXVaultObject.prototype.uploadFile = function (id)
{
    ...
    if ( this.isUploadFile == "false" )
    {
          ...
          //get info
            ...
            this.uploadForm.action = this.pathUploadHandler + "?sessionId=" + this.sessionId + "&fileName=" + this.getFileName(this.getCurrentInputFile(id).value)+"&userfile="+this.getCurrentInputFile(id).id;
