...
dhtmlXWindows.prototype._enableWebMenu = function() {
	this._attachWebMenu = function(win) {
		...
		win.menu = new dhtmlXMenuBarObject("topId",'100%',25);
			var skin = "glassy_blue";
		switch (this.skin) {
			case "glassy_blue":
            case "glassy_blue_light":
            win._menuH = 23;win._menuT = 23;
			break;
			case "dhx_black":
            case "dhx_blue":
 skin = this.skin;
 if (win.toolbar != null){
	...
	if (_isIE){win._IEFixMTS = true;
	var pad = win._menuT + (win._toolbarT!=null?win._toolbarT:0) + (win._sbH!=null?win._sbH:0);win._content.childNodes[2].style.paddingBottom = pad + "px"};
	if (_isOpera && win.layout != null){win.layout._fixCellsContentOpera950()};
