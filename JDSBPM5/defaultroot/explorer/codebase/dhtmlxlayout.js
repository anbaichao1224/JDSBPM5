...
function dhtmlXLayoutObject(base, view, skin){
    ...
    if (!base._skipChecksOnStartUp) {
        ...
        if (base._isWindow == true) {
            ...
            if (this._updateDimensions == true) {
                layout._dimension = new Array(0, 0)
            };
            return layout
        }
        else 
    ...
    this._xmlParser = function(){
        ...
        if (that.base.style.height != null) {
            totalHeight = parseInt(that.base.style.height)
        };
        if (isNaN(totalHeight)) {
            totalHeight = that.base.offsetHeight
        };
        if (isNaN(totalHeight)) {
            alert("init error, incorrect height of parent object, aborted");
            return
        };
                ...
                for (var w = 0; w < row.childNodes.length; w++) {
                    if (row.childNodes[w].tagName == "cell") {
                        ...
                        if (cell.getAttribute("obj") != null) {
                            ...
                            if (cell.getAttribute("width") != null) {
                                td.style.width = cell.getAttribute("width")
                            };
                            if (cell.getAttribute("height") != null) {
                                td.style.height = cell.getAttribute("height")
                            };
    ...
    this._buildSurface = function(){
        for (var r = 0; r < this.tpl.childNodes[0].childNodes.length; r++) {
            ...
            for (var c = 0; c < tr.childNodes.length; c++) {
                ...
                if (!td._isSep) {
                    ...
                    td.attachURL = function(url,ajax){
                        this._url = this.window.attachURL(url,ajax);
                ...
                td.ondblclick = function(){
                    ...
                    if (that.polyObj[this._dblClick] == null) {
                        return
                    };
        ...
        for (var a in p) {
            ...
            "<div class='dhtmlxInfoButtonShowHide_" +
            bar._resize +
            "' title='Collapse'></div>";
            ...
            bar._win = wId;
            bar.childNodes[2].onclick = function(){
                that._expand(this.parentNode._dockCell, "dock")
            };
            bar.childNodes[3].onclick = function(){
        ...
        for (var q = resObj._left.length - 1; q >= 0; q--) {
            if (anyExpL == null) {
                if (typeof(resObj._left[q]) == "object") {
                    ...
                    if (this.polyObj[resObj._left[q]]._collapsed == false) {
        ...
        for (var q = 0; q < resObj._right.length; q++) {
            if (anyExpR == null) {
                if (typeof(resObj._right[q]) == "object") {
                    ...
                    if (this.polyObj[resObj._right[q]]._collapsed == false) {
        ...
        for (var q = resObj._top.length - 1; q >= 0; q--) {
            if (anyExpT == null) {
                if (typeof(resObj._top[q]) == "object") {
                    ...
                    if (this.polyObj[resObj._top[q]]._collapsed == false) {
        ...
        for (var q = 0; q < resObj._bottom.length; q++) {
            if (anyExpB == null) {
                if (typeof(resObj._bottom[q]) == "object") {
                    ...
                    if (this.polyObj[resObj._bottom[q]]._collapsed == false) {
    ...
    this._resizeStop = function(){
        ...
        if (this._effects["resize"] == false) {
            ...
            if (typeof(this._anyExpT) == "object" && this._anyExpT != null) {
                this._fixInnerContentFromArray(this._anyExpT);
                this._anyExpT = null
            };
            if (typeof(this._anyExpB) == "object" && this._anyExpB != null) {
                this._fixInnerContentFromArray(this._anyExpB);
                this._anyExpB = null
            };
            if (typeof(this._anyExpL) == "object" && this._anyExpL != null) {
                this._fixInnerContentFromArray(this._anyExpL);
                this._anyExpL = null
            };
            if (typeof(this._anyExpR) == "object" && this._anyExpR != null) {
                this._fixInnerContentFromArray(this._anyExpR);
                this._anyExpR = null
            };
            this._resObj = null;
            this._resFunc = null;
        ...
        for (var q = 0; q < poly.length; q++) {
            if (typeof(poly[q]) == "object") {
                for (var w = 0; w < poly[q].length; w++) {
                    wId[wId.length] = this.polyObj[poly[q][w]]._win
                }
            }
            else {
        ...
        for (var q = 0; q < wId.length; q++) {
            if (this.dhxWins.window(wId[q]) != null) {
                this._updateComponentsView(this.dhxWins.window(wId[q]))
            }
        };
        this.callEvent("onPanelResizeFinish", [])
    };
    ...
    this._expandEffect = function(obj, obj2, maxSize, mode, step, dir){
        ...
        if (newS != maxSize) {
            ...
            var win = this.dhxWins.window(wId);
            if (!win._isDocked) {
                this.dockWindow(obj._idd, wId)
            };
            for (var q = 0; q < obj2.length; q++) {
                if (obj2[q]._win != null) {
                    this._updateComponentsView(this.dhxWins.window(obj2[q]._win))
                }
            };
    ...
    this._setWidth = function(pId, width){
        ...
        if (sep != null) {
            ...
            if (width < this._minWidth) {
                ...
                if (width > sumSize - this._minWidth) {
    ...
    this._setHeight = function(pId, height){
        ...
        if (sep != null) {
            ...
            if (height < this._minHeight) {
                ...
                if (height > sumSize - this._minHeight) {
    ...
    this._fixInnerContentFromArray = function(obj){
        for (var q = 0; q < obj.length; q++) {
            if (typeof(obj[q]) == "object") {
                this._fixInnerContentFromArray(obj[q])
            }
            else {
    ...
    this.dockWindow = function(pId, wId){
        ...
        win._isDocked = true;
        win._dockCell = pId;
        while (this.polyObj[pId].childNodes.length > 1) {
            this.polyObj[pId].removeChild(this.polyObj[pId].childNodes[1])
        };
            ...
            if (idx != -1) {
                for (var q = idx + 1; q < data.length; q++) {
                    if (typeof(data[q]) == "object") {
                        ...
                        if (this.polyObj[data[q]]._collapsed == false) {
                            newIcon = (this.polyObj[a]._resize == "ver" ? (cps ? "b" : "t") : (cps ? "r" : "l"))
                        }
                };
    ...
    this._defineWindowMinDimension = function(win, inLayout){
        ...
        if (minHeight < that._dimension[1]) {
    ...
    this.setSizes = function(winObj){
        ...
        if (_isIE) {
            ...
            if (winObj.toolbar != null) {
                wh = wh - winObj._toolbarH
            }
        };
        var ax = ww - bw;
        var ay = wh - bh;
        ...
        for (var a in both) {
            this._updateComponentsView(this.dhxWins.window(this.polyObj[a]._win))
        };
...
dhtmlXLayoutObject.prototype.dhxLayout_destructor = function(){
    this.destructor = function(){
        var vars = new Array("_CPanelBtnsWidth", "_CPanelHeight", "_resFunc", "_resObj", "_resX", "_resY", "_totalCols", "_totalRows", "_autoHor", "_autoVer", "_anyExpB", "_anyExpL", "_anyExpR", "_anyExpT", "_layoutView", "_minHeight", "_minWidth", "_availAutoSize", "_dimension", "_effects", "_collapsedH", "_collapsedW", "_colsRatio", "_rowsRatio", "h", "w", "skin", "imagePath");
