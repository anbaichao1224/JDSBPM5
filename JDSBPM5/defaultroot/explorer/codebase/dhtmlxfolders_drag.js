...
*/
    dhtmlxFolders.prototype.enableContextMenu=function(menu){
        this.bodyContextMenu=menu;
    };
	  dhtmlxFolders.prototype.enableFileContextMenu=function(menu){
        this.fileContextMenu=menu;
    };
	  dhtmlxFolders.prototype.enableFolderContextMenu=function(menu){
	...
	*/
    dhtmlxFolders.prototype._dragInTree=function(tree,tobj,bnod,item){
    	...
    	for (var i=0; i<that._dragged.length; i++){
			...
			tree.moveItem(id,'item_child',tobj.id);
