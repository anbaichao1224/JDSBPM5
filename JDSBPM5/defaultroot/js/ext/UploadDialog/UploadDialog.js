...
Ext.extend(Ext.ux.UploadDialog.Dialog, Ext.Window, {
  ...
  {
  /*  try{
    if((typeof refGridById)=="function" && (typeof getActiveFormId)=="function"){
