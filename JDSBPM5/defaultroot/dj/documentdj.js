Ext.onReady(function() {
	...
	startlc = function() {
		Ext.Ajax.request({
			url : '/SwdjAction_startP.action?xmlmodel=<ww:property value="xmlmodel"></ww:property>',
	...
	var grid = new Ext.grid.GridPanel({
		...
		tbar : new Ext.Toolbar(['来文标题：', docname, '来文单位：', department, '来文日期：',
				rdata, {// 查询按钮
					id : 'newModelButton',
					...
					handler : function() {
						...
						Ext.Ajax.request({
							url : '/djAction_delDj.action?xmlmodel=<ww:property value="xmlmodel"></ww:property>',
							params : {
								deluuid : deluuid
							},
							success : function(resp, opts) {
	...
	function addDj() {
		...
		var addForm = new Ext.form.FormPanel({
			...
			labelWidth : 100,
			frame : true,
			url : '/djAction_saveDj.action?xmlmodel=<ww:property value="xmlmodel"></ww:property>',
	...
	function updateDj() {
		...
		var updateForm = new Ext.form.FormPanel({
			...
			labelWidth : 100,
			frame : true,
			url : '/djAction_updateDj.action?xmlmodel=<ww:property value="xmlmodel"></ww:property>',
			defaultType : 'textfield',
			// autoDestroy : false,
			items : [{
						fieldLabel : '编号',
