		...
		<script src="/js/JDS.js" type="text/javascript"></script>
			...
			Ext.onReady(function(){
			  var kssj = new Ext.form.DateField({
				...
				emptyText:'请选择',
				format:'Y-m-d',
				value:'<ww:property value="rfod.rdate"/>'	
			  });
			});
		</script>
	</head>
	<body>
		<form id="updateDj" action="LwdjAction_updateDj.action" method="post">
		<input type="hidden" name="tid" id="tid" value='<ww:property value="rfod.uuid"></ww:property>' />
		<input type="hidden" name="xmlmodel" id="xmlmodel" value='<ww:property value="xmlmodel"></ww:property>' />
		<input type="hidden" name="uuid" id="uuid" value='<ww:property value="rfod.uuid"></ww:property>' />
			<table align="center" width="722" height="491" border="1"
				...
				<tr>
					...
					<td width="249" align="center">
						<input name="djbh" type="text" value='<ww:property value="rfod.sn"></ww:property>'></input>
					</td>
					<td width="68">
						<div align="center">
					...
					<td width="99" align="center">
						...
						<script type="text/javascript">
							document.getElementById('djmj').value = '<ww:property value="rfod.classification"></ww:property>';
						</script>
					</td>
					<td width="87">
						<div align="center">
					...
					<td width="147" align="center">
						...
						<script type="text/javascript">
							...
							document.getElementById('djjjcd').value = '<ww:property value="rfod.emergency"></ww:property>';
						</script>
					</td>
				</tr>
				<tr>
					...
					<td colspan="5" align="center">
						<textarea name="djlwbt" cols="75" rows="2"><ww:property value="rfod.docbt"></ww:property></textarea>
					</td>
				</tr>
				<tr>
					<td height="53">
					...
					<td colspan="2" align="center">
						<textarea name="djlwdw" cols="33" rows="2"><ww:property value="rfod.department"></ww:property></textarea>
					</td>
					<td>
						<div align="center">
