...
%>
 {
    currPerson:{
	    personid:'<ww:property value="person.ID"/>',
		username:'<ww:property value="person.name"/>',
		password:'<ww:property value="person.password"/>',
		currUserOrgName:'<ww:property value="person.orgs[0]"/>',
		sessionid:'<ww:property value="sessionid"/>'
    },
	desktopConfig:{ 
		   launchers:{ 
				...
				rightbar:<ww:property value="#rightbar= desktop.property.rightbar, (#rightbar==null||#rightbar=='') ? '[]':#rightbar"  escape="false"/>,
				...
				'styles': {
	             'theme': {
						...
						'pathtofile': '<%=contextpath%><ww:property value="desktop.cssBean.pathtofile"  escape="false"/>'
					},
					...
					'wallpaperfile': '<%=contextpath%><ww:property value="desktop.wallpaperBean.pathtofile"  escape="false"/>'
				}
	   },
