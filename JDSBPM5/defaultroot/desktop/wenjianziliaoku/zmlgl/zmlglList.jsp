...
<%
	...
	System.out.println(catalogUuid);
...
<html>
	...
	<script type="text/javascript">
		...
		var proxy = new Ext.data.HttpProxy({
			url :'wjzlCatalogAction_findAllZml.action?catalogUuid=<%=catalogUuid %>'
		});
         ...
         // 不允许使用点击表格形式修改选择  
			...
			var grid = new Ext.grid.GridPanel({
				...
				['-',{
					...
					handler : function(){
						...
						var addwin = new Ext.Window({
							...
							minHeight : 40,
							y:0,
							html:"<iframe id='addiframe' name='addiframe' width='" + (_width-10)  + "' height='" + (_height - 10) + "' src='wjzlCatalogAction_toAddZml.action?catalogUuid=<%=catalogUuid%>'></iframe>",
							tbar:[{
									id : 'rjsave',
				...
				handler : updatepage
						...
						handler : function() {
							...
							Ext.Ajax.request({
								url : 'wjzlCatalogAction_deleteZml.action',
								params : {
									catalogId : deluuid
								},
			...
			function showupdatewin(uuid){
				...
				var updatewin = new Ext.Window({
					...
					minHeight : 200,
					y:0,
					html:"<iframe id='updateiframe' name='updateiframe' width='" + (_width-30)  + "' height='" + (_height - 70) + "' src='wjzlCatalogAction_toUpdateYm.action?catalogId="+uuid+"'></iframe>",
					tbar:[{
						id : 'rjsave',
						icon : "/usm/img/save.gif",
						text : '修  改',
