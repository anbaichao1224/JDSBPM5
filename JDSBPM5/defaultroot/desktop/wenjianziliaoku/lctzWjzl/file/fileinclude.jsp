...
function refFileGridById(){
  ...
  if(obj){
	...
	var accachGridCfg={
	  ...
	  selfCfg:{
		...
		renderTo:getActiveFormId(),	
			 ...
			 
			 {
	                   ...
	                   text:'添加文件',
	                   handler: function(){
	                   	var dia=new Ext.ux.UploadDialog.Dialog({upload_autostart:true,url:contextfile+'rattachUploadwjzl.action',base_params:{'recordid':sxxxid,'personId':personid}});
	  ...
	  dataUrl:"filelist.action?sxxxid="+sxxxid+"&personId="+personid
	};
...
showAttachWin();
  ...
  function deleteFile(grid){
	...
	var delAllList=new Array();
	  ...
	  JDS.ajax.Connection.LoadJsonFromUrl(contextfile+'filedel1.action',null,str);
