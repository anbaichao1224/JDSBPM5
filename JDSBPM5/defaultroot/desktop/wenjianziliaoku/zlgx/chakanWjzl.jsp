...
<%
	...
	if(date1!=null){
	   ...
	   //System.out.println(lwDate+"lwDate");
	}
	
	//将创建时间接过来  不允许修改起格式（带有时分秒）
	String createDate = "";
...
<html>
	...
	<body >
		<form id="chakan" name="chakan" action="" method="post">
			...
			<table width="783" height="824" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
			  <tr>
			    <td height="88" colspan="4"  class="bt" align="center">文 件 资 料 查 看</td>
			  </tr>
			  <tr>
			    <td height="70" class="zt" align="center">登记人</td>
			    <td width="200">&nbsp;<input type="text" readonly="readonly" id="wjzl.creatorName" name="wjzl.creatorName" value="<ww:property value="wjzl.creatorName"/>" ></input></td>
			    <td width="110" class="zt" align="center">来文时间</td>
			    <td>
			    	<input readonly="readonly" type="text" name="wjzl.meterialDate" id="wjzl.meterialDate" />
			    </td>
			  </tr>
			  <tr>
			    <td height="70" class="zt" align="center">文号</td>
			    <td>&nbsp;<input readonly="readonly" type="text" value='<ww:property value="wjzl.meterialWenhao"/>' id ="wjzl.meterialWenhao" name="wjzl.meterialWenhao" size="50" /></td> 
			    <td class="zt" align="center">等级</td>
			    <td>
			    	<ww:select disabled="true" cssStyle="width:100px; font-size:18px;"  list="{'平急','加急','特急','特提'}" name="wjzl.meterialDengji" ></ww:select>
			    </td>
			  </tr>
			  <tr>
			    ...
			    <td>
			    	<ww:select disabled="true" onchange="updateAnNiu()" cssStyle="width:100px; font-size:18px;"  list="#{'0':'不公开','1':'部分公开','2':'公开'}" name="wjzl.openType" id="wjzl.openType" ></ww:select>
			    </td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			    ...
			    <td colspan="3">&nbsp;<textarea name="buMenName" id="buMenName" rows="4" onkeydown="return false;" cols="78"><ww:property value="buMenName"  /></textarea>
			  ...
			  <tr>
			    ...
			    <td colspan="3">&nbsp;<textarea readonly="readonly" id="wjzl.meterialTitle" name="wjzl.meterialTitle" cols="78" rows="4"><ww:property value="wjzl.meterialTitle"/></textarea></td>
			  </tr>
			  <tr>
			    <td height="85" class="zt" align="center">副标题</td>
			    <td colspan="3">&nbsp;<textarea readonly="readonly" id="wjzl.meterialFubiaoti" name="wjzl.meterialFubiaoti" cols="78" rows="4"><ww:property value="wjzl.meterialFubiaoti"/></textarea></td>
			  </tr>
			  <tr>
			    <td height="85" class="zt" align="center">主题词</td>
			    <td colspan="3">&nbsp;<textarea readonly="readonly" id="wjzl.meterialZhutici" name="wjzl.meterialZhutici" cols="78" rows="4"><ww:property value="wjzl.meterialZhutici"/></textarea></td>
			  </tr>
			  <tr>
			    <td height="100" class="zt" align="center">附件</td>
			    <td colspan="3">&nbsp;<ww:action name="docexfileinclude1" executeResult="true">
			      	   <ww:param name="add">false</ww:param>
						<ww:param name="del">false</ww:param>
			    </ww:action></td>
			  </tr>
			</table>
		</form>
...
<script type="text/javascript">
			Ext.onReady(function(){
			  ...
			  Ext.getCmp("shijian").setDisabled(true);
