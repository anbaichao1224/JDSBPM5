...
<body>
	<form id="addRootCatalog" name="addRootCatalog" action="wjzlRootCatalogMangerAction_addRootCatalog.action" method="post">
	<table  width="490" height="365" border="1"  align="center" cellpadding="0" cellspacing="0">
	    ...
	    <tr>
	      ...
	      <tr>
	        ...
	        <td height="56" colspan="-2"><span class="STYLE2">
	        <input size="36" name="sendrange" type="text"   class="STYLE4"   id="sendrange" onkeydown="return false;"  size="50"/>
