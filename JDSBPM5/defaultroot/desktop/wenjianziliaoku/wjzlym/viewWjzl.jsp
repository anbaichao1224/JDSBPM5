		...
		<form id="update" name="update" action="wjzlMeteriaAction_update.action" method="post">
			...
			<table width="783" height="824" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
			  ...
			  <tr>
			    ...
			    <td width="200">&nbsp;<input type="text" readonly="true" id="wjzl.creatorName" name="wjzl.creatorName" value="<ww:property value="$currPerson.name"/>" ></input></td>
			    <td width="110" class="zt" align="center">来文时间</td>
			    <td>
			    	<input type="text" readonly="true" name="wjzl.meterialDate" id="wjzl.meterialDate" />
			    </td>
			  </tr>
			  <tr>
			    <td height="70" class="zt" align="center">文号</td>
			    <td>&nbsp;<input type="text" readonly="true" value='<ww:property value="wjzl.meterialWenhao"/>' id ="wjzl.meterialWenhao" name="wjzl.meterialWenhao" size="50" /></td> 
			  ...
			  <tr>
			    ...
			    <td>&nbsp;<input type="text" readonly="true" id="wjzl.meterialBianhao" value='<ww:property value="wjzl.meterialBianhao"/>' name="wjzl.meterialBianhao"  size="50" /></td>
			  ...
			  <tr>
			    ...
			    <td colspan="3">&nbsp;<textarea id="wjzl.meterialTitle" readonly="true" name="wjzl.meterialTitle" cols="78" rows="4"><ww:property value="wjzl.meterialTitle"/></textarea></td>
			  </tr>
			  <tr>
			    <td height="85" class="zt" align="center">副标题</td>
			    <td colspan="3">&nbsp;<textarea id="wjzl.meterialFubiaoti" readonly="true" name="wjzl.meterialFubiaoti" cols="78" rows="4"><ww:property value="wjzl.meterialFubiaoti"/></textarea></td>
			  </tr>
			  <tr>
			    <td height="85" class="zt" align="center">主题词</td>
			    <td colspan="3">&nbsp;<textarea  id="wjzl.meterialZhutici" readonly="true" name="wjzl.meterialZhutici" cols="78" rows="4"><ww:property value="wjzl.meterialZhutici"/></textarea></td>
			  </tr>
			  <tr>
