...
//       		    id:'depart',
//                text: '部门管理',
//                icon : "/usm/img/157(2).gif", 
//                cls : "x-btn-text-icon", 
//                handler:onItemClick
//          },'-',{
//       		    id:'extsys',
//                text: '退出系统',
//                icon : "/usm/img/227(1).gif", 
//                cls : "x-btn-text-icon", 
//                handler:onItemClick
//          }
//  );
 ...
 buttons: [{
           ...
           treePanel,
             new Ext.Panel({
                           ...
                           // html:'<iframe id="views" frameborder="0" src="depart/departqueryListgrid.jsp" height=100% width=100%></iframe>'
                            html:'<iframe id="views" frameborder="0" src="togridAction.do" height=100% width=100%></iframe>'
   ...
   tree.on('click', function(node){
	   ...
	   if(node.id=='toproot' || node.id=='root'){
	        nodeid=node.id;
	   		tree_refresh();
	   		Ext.get('views').dom.src='togridAction.do;'//'depart/departqueryListgrid.jsp?childOrgId='+nodeid+'';
	   }else{
      	  nodeid=node.id;
	   	  if(type=="right"){ 
	      ...
	      Ext.get('views').dom.src= 'togridAction.do?dwuuid='+node.attributes['id'];
		  }
