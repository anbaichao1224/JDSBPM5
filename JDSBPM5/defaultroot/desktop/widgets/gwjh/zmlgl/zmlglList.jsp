...
<html>
	...
	<script type="text/javascript">
		...
		var proxy = new Ext.data.HttpProxy({
			url :'tbmAction_findAllZml.action?catalogUuid=<%=catalogUuid %>'
		});
				...
				['-',{
					...
					handler : function(){
						...
						var addwin = new Ext.Window({
							...
							minHeight : 40,
							y:0,
							html:"<iframe id='addiframe' name='addiframe' width='" + (_width-10)  + "' height='" + (_height - 10) + "' src='tbmAction_toAddZml.action?catalogUuid=<%=catalogUuid%>'></iframe>",
							tbar:[{
									id : 'rjsave',
