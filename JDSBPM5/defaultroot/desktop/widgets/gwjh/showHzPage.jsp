...
-->
	...
	<body>
		...
		<input type="hidden" name="tid" id="tid" value='<%=inceptid %>'/>
		...
		<input type="hidden" name="liststatus" id="liststatus" value='<%=request.getParameter("liststatus")%>'/>
			...
			<table align="center" width="722" height="491" border="1"
				...
				<!--  </tr>
					...
					<td height="57">
						<div align="center">
							<span class="STYLE4">报名人员</span>
						</div>
					</td>
					<td colspan="3">
						<textarea size="85" class="required" name="deptnames" type="text"
							id="deptnames" onkeydown="return false;" cols="65" rows="4"><ww:property value="deptnames"/></textarea>
				...
				<tr>
					<td height="120" align="center" class="tdClass">
						<div align="center">
							<p class="STYLE4">
								附
							</p>
