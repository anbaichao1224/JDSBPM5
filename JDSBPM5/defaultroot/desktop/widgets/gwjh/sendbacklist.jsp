...
<html>
  <head>
    ...
    <!-- <script src="/desktop/widgets/gwjh/js/sendreplylist.js"></script> -->
...
// 复选框
	...
	var proxy = new Ext.data.HttpProxy({
		url : 'gwjhAction_findsendBacklist.action?uuid='+sendid
	});
	...
	var proxy = new Ext.data.HttpProxy({
		url : 'gwjhAction_findyssendBacklist.action?uuid='+sendid
	});
