...
<body>
	<form id="addRootCatalog" name="addRootCatalog" action="RootAction_addRootCatalog.action" method="post">
	<table  width="490" height="365" border="1"  align="center" cellpadding="0" cellspacing="0">
	   	<tr>
	      <td height="64" colspan="2"><div align="center" class="STYLE1" >单 位 登 记</div></td>
      	</tr>
	    <tr>
	      <td width="106" height="66" align="center"><span class="STYLE2">单位名称 </span></td>
       ...
       <tr>
	      ...
	      <tr>
	      <td align="center" height="177"><span class="STYLE2">单位描述</span></td>
