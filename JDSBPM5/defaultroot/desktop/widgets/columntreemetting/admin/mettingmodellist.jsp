...
<ww:iterator value="modellist" status="rowstatus">
    {
      ...
      namemc:"<a href=javascript:void(0) onclick=window.top.opentype('treemetting_querymodel.action?mettinguuid=<ww:property value="tid"/>','1150','800')> <ww:property value="name"/></a>",
