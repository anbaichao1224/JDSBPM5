			...
			<table align="center" width="722" height="491" border="1"
				...
				<tr>
					...
					<td width="249" align="center">
						<input name="replybean.replyPerson" type="text"  value='<ww:property value="replydao.replyPerson"/>'></input>
					</td>
					<td width="68">
						<div align="center">
					...
					<td width="99" align="center">
						<input name="replybean.replyDept" type="text"  value='<ww:property value="replydao.replyDept"/>'></input>
					</td>
				...
				<tr>
					...
					<td colspan="5" align="center">
						<textarea name="replybean.replyContent" cols="75" rows="5"><ww:property value="replydao.replyContent"/></textarea>
					</td>
				</tr>
				<tr>
