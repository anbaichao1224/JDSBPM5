	...
	<script type="text/javascript">
			...
			document.getElementsByName("$Fdtnmswbl.fdtOaNmswblDAO.ywbh").item(0).value='<%=dao.getYwbh()%>';
			...
			document.getElementsByName("$Fdtnmswbl.fdtOaNmswblDAO.jjcd").item(0).value='<%=dao.getJjcd()%>';
