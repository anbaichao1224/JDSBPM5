...
function refFileGridById(){
  ...
  if(obj){
	...
	var accachGridCfg={
	  ...
	  dataUrl:"fileList.action?activityInstId="+activityInstId+"&formId="+formid+"&activityInstHistoryId="+activityInstHistoryId+"&personId="+personid
	};
  ...
  function deleteFile(grid){
	...
	var delAllList=new Array();
	  ...
	  JDS.ajax.Connection.LoadJsonFromUrl(contextfile+'filedel.action',null,str);
