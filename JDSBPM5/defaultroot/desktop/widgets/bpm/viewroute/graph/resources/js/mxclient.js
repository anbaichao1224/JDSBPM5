...
IS_FFIS:navigator.userAgent.indexOf('Firefox/3.5')>=0||navigator.userAgent.indexOf('Iceweasel/3.5')>=0,
...
var imageNode=null;
if(imgName.substring(imgName.length-3,imgName.length).toUpperCase()=='PNG'&&true&&!false)
{
...
if(mxClient.IS_FFIS)
{
this.imageNode.setAttribute('stroke','black');
}
...
if(imgName.substring(imgName.length-3,imgName.length)=="PNG"&&true&&!false)
{
