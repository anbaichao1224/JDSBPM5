...
<form name="form" id="form"  method="post" action="${contextPath}/GrbgGzrz_save.action"  enctype="multipart/form-data" >
	...
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" borderColorDark="#ffffff" borderColorLight="#999999">
		...
		<tr class="trf">
			...
			<td width="32%" class="tdv"><input type="text" readonly name="grbgGzrz.dateFrom" id="dateFrom"  class="required date-lt-dateTo" value="${now }"><button pattern="minute" target="dateFrom">选择</button>
			<font color="red">*</font></td>	
			<td width="18%" class="tdl">截止时间</td>
			<td width="32%" class="tdv"><input type="text" readonly name="grbgGzrz.dateTo" id="dateTo" class="required date-gt-dateFrom" value="${now}"><button pattern="minute" target="dateTo">选择</button>
			<font color="red">*</font></td>	
		</tr>
		<tr class="trf">
			<td width="18%" class="tdl">日志类型</td>
			<td colspan="3" class="tdv"><input type="text" name="grbgGzrz.rzType" class="required" style="width:80%" maxlength="32"/><font color="red">*</font></td>
		</tr>
		<tr class="trf">
			<td align="center" class="tdl" width="14%">工作内容</td>
			<td class="tdv" width="36%" colspan="3">	
				<textarea name="grbgGzrz.rzContent" rows="12" id="grbgGzrz.rzContent" style="width:90%" class="required"  onkeydown="textCounter(this,480);" onkeyup="textCounter(this,480);" ></textarea><font color="red">*</font>
			</td>	
		</tr>
	</table>
