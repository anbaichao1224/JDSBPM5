...
<link rel="stylesheet" href="<%=request.getContextPath() %>/dhtmlxScheduler/dhtmlxscheduler.css" type="text/css" media="screen" title="no title" charset="utf-8"/>
<script src="<%=request.getContextPath() %>/dhtmlxScheduler/dhtmlxscheduler.js" type="text/javascript" charset="utf-8"></script>
<link rel="stylesheet" href="<%=request.getContextPath() %>/dhtmlxScheduler/dhtmlxscheduler.css" type="text/css" charset="utf-8">
<script src="<%=request.getContextPath() %>/dhtmlxScheduler/locale_cn1.js" type="text/javascript" charset="utf-8"></script>
<script src="<%=request.getContextPath() %>/ext/dhtmlxscheduler_agenda_view.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath() %>/ext/dhtmlxscheduler_ext.css" type="text/css">
<script src="<%=request.getContextPath() %>/dhtmlxScheduler/locale_recurring_cn.js" type="text/javascript" charset="utf-8"></script>

<script src="<%=request.getContextPath() %>/dhtmlxToolbar/dhtmlxcommon.js"></script>
<script src="<%=request.getContextPath() %>/dhtmlxToolbar/dhtmlxtoolbar.js"></script>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/dhtmlxToolbar/skins/dhtmlxtoolbar_dhx_skyblue.css"></link>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/dateday.js"></script>
...
<script language="JavaScript">
	...
	function toolBarInit(){
		...
		toolbar.setIconsPath("<%=request.getContextPath() %>/dhtmlxToolbar/icon/");
		toolbar.attachEvent("onClick", toolBarClick);
		toolbar.attachEvent("onXLE", toolBarXLE);
		toolbar.loadXML("<%=request.getContextPath() %>/pages/gzrz/gzrz.xml?etc="+new Date().getTime());
	}
	function toolBarXLE(){
	...
	function addOrUpdate(event_id,event_object){
		...
		new Ajax.Request('<%=request.getContextPath() %>/GrbgGzrz_saveOrUpdate.action', {
			 method: 'post',
	...
	function del(event_id,event_object){
		var retvalue = true;
		new Ajax.Request('<%=request.getContextPath() %>/GrbgGzrz_del.action', {
			 method: 'post',
...
//		alert(mode);
		...
		var url = "<%=request.getContextPath() %>/GrbgGzrz_findAllEvent.action?date=" + date1.toLocaleString() + "&queryModel=" + mode1 + "&oday=" + datestr;
		//alert(url);
		scheduler.load(url);
		return true;
	}
...
<body onload="init();" >
	<!--  <div align="right" id="toolbarObj" style="width:100%;"></div>-->
