...
<html>
  <head>
    ...
    <title>My JSP 'sxtx.jsp' starting page</title>
...
<script language="JavaScript">
	...
	function addOrUpdate(event_id,event_object){
		...
		new Ajax.Request('/sxtxAction.action', {
			 method: 'post',
	...
	function del(event_id,event_object){
		var retvalue = true;
		new Ajax.Request('/sxtxAction_delete.action', {
			 method: 'post',
	...
	function beforeViewChange(old_mode, old_date, mode , date){
		...
		var url = "/sxtxAction_find.action?date=" + date1.toLocaleString() + "&queryModel=" + mode1 + "&oday=" + datestr;
		scheduler.load(url);
		return true;  
	}
