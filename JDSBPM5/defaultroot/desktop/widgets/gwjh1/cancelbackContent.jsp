			...
			items : [ {
			    ...
			    items:[{
			       ...
			       items:[  
			         ...
			         {fieldLabel:'签收人',readOnly:true,width:180,name:'sendbean.sendSigner',value:'<ww:property value="dao.sendSigner"/>'},
			         {fieldLabel:'签收单位',readOnly:true,width:180,name:'sendbean.sendSigndept',value:'<ww:property value="dao.sendSigndept"/>'},
