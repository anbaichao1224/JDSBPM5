...
<ww:iterator value="fileBeanList" status="rowstatus">
    {
     ...
     filename:"<a href=\"javascript:window.top.djopenpdf('<ww:property value="uuid"/>','<%=basePath %>')\"> <ww:property value="filename"/></a>",
      </ww:if>
     <ww:else>
     filename:"<a href='<ww:property value="filePath"/>mdownloadfile.action?uuid=<ww:property value="uuid"/> ''><ww:property value="filename"/></a>",
