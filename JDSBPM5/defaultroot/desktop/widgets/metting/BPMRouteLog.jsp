   ...
   <ww:iterator value="historyWrpList" status="historystatus">
    {
      ...
      state:"<ww:property value="arrivedTime"/>",
      endTime:"<ww:property value="endTime"/>",
      action: "<input type='button' style='border:1 ;height:15' name='action' value=' 查 看 '  onClick=\"openBL('<ww:property value="activityInstHistory.activityInstId"/>')\">"       
          }  
