  ...
  <TR height=22>
	...
	<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" width="100%">
	  <TR>
		...
		<TD width=3><img src="toolbar/images/toolbar.gif"></TD>
		<TD width=4></TD>
		<TD width=20><img src="toolbar/images/save.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_save()" alt="保存"></TD>
		<TD width=22><img src="toolbar/images/refresh.gif" class="img" onmousedown="down(this,'refresh');" onmouseout="out(this,'refresh');" onmouseover="over(this,'refresh');" onmouseup="over(this,'refresh');" border=1 onclick="_refresh()" alt="刷新"></TD>
		<!--TD width=6 align=center><img src="toolbar/images/tiao.gif"></TD>
		<TD width=20><img src="toolbar/images/cut.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_cut()" alt="剪切选中的内容到剪贴板"></TD>
		<TD width=20><img src="toolbar/images/copy.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_copy()" alt="复制选中的内容到剪贴板"></TD>
		<TD width=20><img src="toolbar/images/paste.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_paste()" alt="粘贴剪贴板中的内容"></TD>
		<TD width=20><img src="toolbar/images/delete.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_delete()" alt="删除选中的内容"></TD-->
		<TD width=22><img src="toolbar/images/del.gif" class="img" onmousedown="down(this,'del');" onmouseout="out(this,'del');" onmouseover="over(this,'del');" onmouseup="over(this,'del');" border=1 onclick="_delete()" alt="删除选择的内容"></TD>
		<TD width=6 align=center><img src="toolbar/images/tiao.gif"></TD>
		...
		<TD width=22><img src="toolbar/images/help.gif" class="img" onmousedown="down_(this);" onmouseout="out_(this);" onmouseover="over_(this);" onmouseup="over_(this);" border=1 onclick="_help()" alt="JWebEdit 帮助"></TD>
