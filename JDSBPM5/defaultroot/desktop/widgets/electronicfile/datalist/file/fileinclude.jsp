...
String attid = new UUID().toString();
 ...
 <script>
	...
	if(blstatus!=""){
		sxxxid = '<ww:property value="mettingbean.dataId"/>';
	}*/
	if(sxxxid==""){
		sxxxid = document.getElementById("dataId").value;
...
function refFileGridById(){
  ...
  if(obj){
	...
	var accachGridCfg={
	  ...
	  dataUrl:"/rfileList.action?recordid="+sxxxid+"&personId="+personid
	};
  ...
  function deleteFile(grid){
	...
	var delAllList=new Array();
	  ...
	  JDS.ajax.Connection.LoadJsonFromUrl(contextfile+'rfiledel.action',null,str);
