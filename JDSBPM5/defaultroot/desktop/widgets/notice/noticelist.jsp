...
<ww:iterator value="nlist" status="rowstatus">
    {
      ...
      niticetitle:"<a href=javascript:void(0) onclick=opentype('noticeAction_findById.action?uuid=<ww:property value="uuid"/>','1175','800')> <ww:property value="niticetitle"/></a>",
