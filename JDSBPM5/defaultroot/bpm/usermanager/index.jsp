...
var tree=new Ext.tree.TreePanel({
    ...
    sm.on('beforeselect', function(sm, node){
		...
		tree.body.mask('加载中...','x-mask-loading');
		 ...
		 Ext.get("rolling7").dom.src="<%=contextpath%>bpm/usermanager/allcomputer.jsp";
   	 }else{
	     Ext.get("rolling7").dom.src="<%=contextpath%>bpm/usermanager/computerInfo.jsp?nodeid="+node.id;
	     }
