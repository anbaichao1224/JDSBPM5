...
<!--
	...
	PERFORMTYPE_JOINTSIGN = "<%=OARightConstants.PERFORMTYPE_JOINTSIGN%>";
		...
		PERFORMTYPE_SINGLE = "<ww:property value="@OARightConstants@PERFORMTYPE_SINGLE"/>";
	PERFORMTYPE_MULTIPLE = "<ww:property value="@OARightConstants@PERFORMTYPE_MULTIPLE"/>";
	PERFORMTYPE_NOSELECT = "<ww:property value="@OARightConstants@PERFORMTYPE_NOSELECT"/>";
	PERFORMTYPE_JOINTSIGN = "<ww:property value="@OARightConstants@PERFORMTYPE_JOINTSIGN"/>";
...
function selectorg(o, id)
{
	...
	if (currentPerformType == PERFORMTYPE_JOINTSIGN) {
		if(id != "<ww:property value="@OrgHTMLTree@ALL_PERSON"/>"){
