...
<%
	...
	net.itjds.usm.common.model.UserInfo userInfo=(net.itjds.usm.common.model.UserInfo)session.getAttribute("_j2ee_user");
	
	java.lang.Integer personId = userInfo.getPersonId();
