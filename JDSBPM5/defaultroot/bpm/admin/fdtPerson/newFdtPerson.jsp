...
<form name="frm" method="post" action="newFdtPerson_do.jsp" onSubmit="return _check();">
  ...
  <tr> 
    <td height="500" align="center" valign="top"> <TABLE width="100%" border=0 align=center cellspacing="3">
      <tr height="21" valign="bottom">
        <td width="500" class="lin3"><font color="FB4303">■ 当前位置 》新建表单设计人员</font></td>
      </tr>
      <tr>
        <td height="8"> </td>
      </tr>
