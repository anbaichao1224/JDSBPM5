...
<%
    ...
    String updateSQL = "UPDATE ADMIN_BPMSYS_PERSON SET PERSON_SELECT_FORMULA='"+PERSON_SELECT_FORMULA+"' WHERE PERSON_ID='"+PERSON_ID+"' AND APPNAME='"+APPNAME+"' AND MODULE_NAME='FDT'";
