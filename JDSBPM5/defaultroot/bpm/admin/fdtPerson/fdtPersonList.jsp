...
<%
    ...
    String querySQL = "SELECT PERSON_ID, APPNAME, PERSON_SELECT_FORMULA FROM ADMIN_BPMSYS_PERSON WHERE MODULE_NAME='FDT' "+orderByStr;
...
<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    <!-- 列表 begin -->
    <td height="100%" align="center" valign="top"> <TABLE width="100%" border=0 align=center cellspacing="3">
        <tr height="21" valign="bottom"> 
          <td width="100%" class="lin3"><font color="FB4303">■ 当前位置 》表单设计人员列表</font></td> 
        </tr> 
      </table> 
      <br> 
        ...
        <input type="hidden" name="formids" value="">
          <TR align=center bgColor=#E3E8F8>
            <td height="21" width="10%" class="td" bgcolor="E3E8F8">编号</td> 
            <td width="20%" height="21" bgcolor="E3E8F8" class="td"><a href="fdtPersonList.jsp?order=1">人员名称</a></td>
            <td width="20%" height="21" bgcolor="E3E8F8" class="td"><a href="fdtPersonList.jsp?order=2">应用</a></td>
        ...
        %>
          <tr height="21"> 
            ...
            <td align="center" class="td"><a href="modFdtPerson.jsp?PERSON_ID=<%=personID %>&APPNAME=<%=appName %>" class="A_1">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="delFdtPerson.jsp?PERSON_ID=<%=personID %>&APPNAME=<%=appName %>" class="A_1">删除</a></td>
          </tr> 
        <%
            }catch(Exception e) {
                logger.error("", e);
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"> 
        ...
        <tr align="center"> 
          <td height="50" width="100%">
            <input name="Submit223" type="button" class="inputbutton" style="cursor:hand;" value="新 建" onclick="window.location='newFdtPerson.jsp'"> 
          </td> 
        </tr> 
      </table> 
      <!-- 操作 end --> 
