<%
/**
 *    $RCSfile: newProcessDefPerson_do.jsp,v $
 *    $Author: liyang $
 *    $Revision: 1.2 $
...
<%
    ...
    String querySQL = "SELECT PERSON_ID FROM ADMIN_BPMSYS_PERSON WHERE PERSON_ID='"+PERSON_ID+"' AND APPNAME='"+APPNAME+"' AND MODULE_NAME='BPD'";
    ...
    String insertSQL = "INSERT INTO ADMIN_BPMSYS_PERSON (PERSON_ID, APPNAME, PERSON_SELECT_FORMULA, MODULE_NAME) VALUES ('"+PERSON_ID+"','"+APPNAME+"','"+PERSON_SELECT_FORMULA+"', 'BPD')";
