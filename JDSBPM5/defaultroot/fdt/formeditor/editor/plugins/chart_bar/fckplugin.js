var oItem = new FCKToolbarButton('chart_bar', '条形图') ;
oItem.IconPath = FCKPlugins.Items['chart_bar'].Path + 'chart_bar1.jpg';
FCKToolbarItems.RegisterItem('chart_bar', oItem);

var FCKobj = new Object() ;
FCKobj.name = 'chart_bar';

FCKobj.Execute = function()
{
    var oDiv = FCK.InsertElement('div');
    oDiv.className = 'document';
    oDiv.setAttribute('cusType', 'barchart');
    oDiv.style.display = 'inline';
    //    oDiv.innerHTML='<img id="life" src="/formeditor/editor/images/mydocument.jpg"/>' ;
    var oImg = FCK.EditorDocument.createElement("img");
    oImg.src = '/fdt/formeditor/editor/plugins/chart_bar/chart_bar.jpg';
...
FCKCommands.RegisterCommand('chart_bar', FCKobj);
