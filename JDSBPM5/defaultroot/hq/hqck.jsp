...
<html>
    ...
    <body>
        ...
        <form id="hqck" action="" method="post">
       <input type="hidden" name="yewuuuid" id="yewuuuid" value='<ww:property value="hqy.uuid"></ww:property>' />
		...
		<table border="0" cellspacing="0" cellpadding="0" width="983" align="center" height="75">
          <tbody>
            <tr>
		...
		<div align="center">
          <table border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" width="1004" align="center" height="1203" style="width: 998px; height: 1263px">
            <tbody>
              ...
              <tr>
                <td class="tdClass" height="45" colspan="2" align="center"><strong>印发份数：<input name="yffs" type="text" class="STYLE4" id="yffs" value='<ww:property value="hqy.yffs"/>' size="10" readonly="true">份</strong></td>
                  <td class="tdClass" height="45" colspan="2"><strong>印发时间：<input name="yfsj" type="text" class="STYLE4" id="yfsj" value="<%=yfsj%>" size="10" readonly="true"></strong></td>
                  <td class="tdClass" height="45" align="center"><strong>校对</strong></td>
                <td width="99" class="tdClass"><input name="xd" type="text" class="STYLE4" id="xd" value='<ww:property value="hqy.xd"/>' size="10" readonly="true"></td>
                  <td class="tdClass" height="45" width="66" align="center"><strong>打字</strong></td>
                <td width="112" class="tdClass"><input name="dz" type="text" class="STYLE4" id="dz" value='<ww:property value="hqy.dz"/>' size="10" readonly="true"></td>
              </tr>
              <tr>
