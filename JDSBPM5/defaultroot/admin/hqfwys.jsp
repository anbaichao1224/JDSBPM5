...
.x-grid3-row td,.x-grid3-summary-row td {
	...
	var proxy = new Ext.data.HttpProxy({
		url : '/Chaxun_HqFwYs.action?username='+username+'&password='+password+'&deptid='+deptid+'&flag='+flag
	});
	...
	function quhui(uuid){
      	Ext.Ajax.request({
			url : '/HqYewuAction_updateFlagTo0.action',
			params : {
				uuid : uuid
			},
		...
		failure : function(resp, opts) {
  		...
  		function showshowwin(uuid){
			...
			var updatewin = new Ext.Window({
					...
					height : _height,
					minHeight : 200,
					html:"<iframe id='djiframe1' name='djiframe1' width='" + (_width-30)  + "' height='" + (_height - 60) + "' src='HqYewuAction_hqjbl.action?uuid="+uuid+"'></iframe>",
					tbar:[
						{
							id : 'djsave',
							...
							cls : "x-btn-text-icon",
							handler : function(){
							   var fn = Ext.get('djiframe1').dom.contentWindow.document.getElementById("hqjbl");
