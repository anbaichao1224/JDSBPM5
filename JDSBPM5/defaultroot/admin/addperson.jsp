...
.tdClass {
	...
	<body>
		<form id="addper" name="addper" action="Chaxun_addPer.action"
			method="post">
			<table width="490" height="320" border="1" align="center"
				...
				<tr>
					...
					<td width="378" height="66" colspan="-2">
						<span class="STYLE2"> <input name="oapersondao.username" type="text"
								id="username" size="36" /> </span>
					</td>
				</tr>
				<tr>
					...
					<td height="56" colspan="-2">
						<span class="STYLE2"> <input name="oapersondao.password"
