...
<html>
  ...
  Ext.onReady(function() {
	...
	url : 'Chaxun_GwYs.action?username='+username+'&password='+password+'&deptid='+deptid+'&flag='+flag
	});
...
function gwjhstartProcess(uuid){
      var _width = 900;
		...
		var addwin = new Ext.Window({
					...
					minHeight : 200,
					y:0,
					html:"<iframe id='djiframe' name='djiframe' width='" + (_width-30)  + "' height='" + (_height - 60) + "' src='TzlcAction_transSWDJ.action?inceptid="+uuid+"'></iframe>",
					tbar:[
						{
							id : 'djsave',
							icon : "/usm/img/save.gif",
