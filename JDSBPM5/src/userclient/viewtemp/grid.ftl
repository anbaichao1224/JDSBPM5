...
@GridPanelDefine(
		...
		buttons = {@ButtonDefine(text=ElementButton.query,iconCls="zoom",hidden = false,handler = "query()"),
				   @ButtonDefine(text=ElementButton.add,iconCls="add",hidden = false,handler = "window.open(context+'fdt/display/formshow.jsp?action=${table.fieldName}.html.jsp')"),

				   @ButtonDefine(text=ElementButton.editstyle,iconCls="serialindex",hidden = false,handler = "window.open(context+'fdt/formeditor/edit.action?fileName=*${table.fieldName}.html')"),
				   @ButtonDefine(text=ElementButton.bindfield,iconCls="edit",hidden = false,handler = "window.open(context+'fdt/designer/fdtDesigner.action?fileName=*${table.fieldName}.html')"),
