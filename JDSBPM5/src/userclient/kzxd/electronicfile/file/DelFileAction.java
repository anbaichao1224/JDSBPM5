	    ...
	    try{
	    	...
	    	factory = new DAOFactory(conn,att);
		    	...
		    	if(ls.size()>0)
		    	{
			    	...
			    	fatt.setWhereClause("recorduuid='"+getatt.getRecordid()+"' and creatorid='"+person.getID()+"' and filename='"+getatt.getFilename()+"'");
