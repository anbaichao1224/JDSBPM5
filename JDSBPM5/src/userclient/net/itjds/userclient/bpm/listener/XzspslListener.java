...
public class XzspslListener implements ActivityListener{
	...
	public void activityCompleted(ActivityEvent event) throws BPMException {
		...
		Object result3=context.getValueStack().findValue("$Fdtnmwsxtsp.fdtOaWsxtspDAO.hq");
		String handleridea=(String) result3;
		Date date=new Date();
