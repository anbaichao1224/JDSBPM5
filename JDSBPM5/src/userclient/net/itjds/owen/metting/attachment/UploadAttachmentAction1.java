...
public class UploadAttachmentAction1 implements Action{
	...
	protected static Log log = LogFactory.getLog(Constants.CONFIG_KEY,
			UploadAttachmentAction1.class);
	public UploadAttachmentAction1()  {
		//super();	
	}
...
public String  saveFileInfo(String path,String sxxxid,String filename)
{
    ...
    //	attdao.setCreatorid(person.getID());
    	...
    	attdao.setCreatorid(Creatorid);
    	attdao.setCreatorname(Creatorname);
